...
const queryPostOrden = ({ codOp, factura, fechaPago, montoBase, pagada, borrado, activo, cuit, idCuentaEmisora }) => `CALL sp_InsertarOrdenPago(${codOp},${factura},${fechaPago},${montoBase},${pagada},${borrado},${activo},${cuit},${idCuentaEmisora});`;
